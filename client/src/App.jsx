  ...
  return (
    <Box>
      <Routes>
        ...
        <Route path="/collaborators" element={<ProtectedRoute><RoleRoute roles={['admin', 'rrhh', 'gerencia', 'supervisor']}><DashboardLayout><Collaborators/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        ...
        <Route path="/collaborators/:id" element={<ProtectedRoute><RoleRoute roles={['admin', 'rrhh', 'gerencia', 'supervisor']}><DashboardLayout><CollaboratorForm/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        <Route path="/sites" element={<ProtectedRoute><RoleRoute roles={['admin','rrhh','operaciones','supervisor','gerencia']}><DashboardLayout><OrganizationManager type="sites"/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        <Route path="/clients" element={<ProtectedRoute><RoleRoute roles={['admin','rrhh','operaciones','supervisor','gerencia']}><DashboardLayout><OrganizationManager type="clients"/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        <Route path="/shifts" element={<ProtectedRoute><RoleRoute roles={['admin','rrhh','operaciones','supervisor','gerencia']}><DashboardLayout><Shifts/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        <Route path="/assignments" element={<ProtectedRoute><RoleRoute roles={['admin','rrhh','operaciones','supervisor','gerencia']}><DashboardLayout><Assignments/></DashboardLayout></RoleRoute></ProtectedRoute>} />
        ...
        <Route path="/personnel/:type" element={<ProtectedRoute><RoleRoute roles={['admin','rrhh','operaciones','supervisor','gerencia','contabilidad']}><DashboardLayout><PersonnelProcesses/></DashboardLayout></RoleRoute></ProtectedRoute>} />
