...
r.get('/productivity',allow('admin','rrhh','operaciones','gerencia'),C.productivityList);
r.post('/productivity',allow('admin','rrhh','operaciones'),C.productivityCreate);
r.get('/productivity/:id',allow('admin','rrhh','operaciones','gerencia'),C.productivityDetail);
r.put('/productivity/:id/evaluations/:collaboratorId',allow('admin','rrhh','operaciones'),C.productivityEvaluate);
