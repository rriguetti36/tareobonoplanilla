...
r.get('/productivity',allow('admin','rrhh','operaciones','gerencia','supervisor'),C.productivityList);
r.post('/productivity',allow('supervisor'),C.productivityCreate);
r.get('/productivity/:id',allow('admin','rrhh','operaciones','gerencia','supervisor'),C.productivityDetail);
r.put('/productivity/:id/evaluations/:collaboratorId',allow('supervisor'),C.productivityEvaluate);
